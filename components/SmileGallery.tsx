...
const transformations: Transformation[] = [
  {
    ...
    beforeImg:
      "https://images.unsplash.com/photo-1658849350672-7a708745b68e?auto=format&fit=crop&w=800&q=80",
    afterImg:
      "https://images.unsplash.com/photo-1677026010083-78ec7f1b84ed?q=80&w=870&auto=format&fit=crop",
  },
  {
    id: "2",
    patient: "Sarah L.",
    ...
    beforeImg:
      "https://images.unsplash.com/photo-1657313611708-17639e445455?q=80&w=984&auto=format&fit=crop",
    afterImg:
      "https://images.unsplash.com/photo-1663182234283-28941e7612da?q=80&w=793&auto=format&fit=crop",
  },
  {
    id: "3",
    patient: "David K.",
    ...
    beforeImg:
      "https://images.unsplash.com/photo-1660732205502-2c4dcd3af74d?q=80&w=870&auto=format&fit=crop",
    afterImg:
      "https://images.unsplash.com/photo-1607378119679-1b10e82b3704?q=80&w=387&auto=format&fit=crop",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-slate-100 pb-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-textMuted font-light max-w-lg">
              Hover over the portraits to see the post-treatment results. We
              believe every smile tells a story of confidence restored.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {transformations.map((item) => (
            <div
              key={item.id}
              className="group relative h-[450px] overflow-hidden rounded-lg cursor-pointer shadow-lg ring-1 ring-slate-100"
            >
